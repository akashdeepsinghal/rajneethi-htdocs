...
app.controller('addbeneficiaryCtrl', function ($scope, $routeParams, $http) {
    ...
    $scope.addbeneficiary = function () {
        ...
        if (projectId == "-1") {
            var projectid = window.localStorage.getItem("projectId");// $("#projectid").val();
            var type = $("#type").val();
            var title = $("#title").val();
            var name = $("#name").val();
           ...
           //  $("#loadingModal").show();
            add = [projectid, title, type,name, voterid, $scope.datetoadd]
            var reqObj = {
